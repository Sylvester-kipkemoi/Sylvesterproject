            ...
            <div class="row">
              <div class="banner-info">
                ...
                <div class="banner-text text-center">
                  ...
                  <h2>ADMIN`S SIGN-UP</h2>
                  <div id="wrapper">

                    <center>
                      <form  id="form" method="POST" action="includes/admin.inc.php">  
                        AdminName: <span class="glyphicon glyphicon-user"></span><br> <input type="text" name="admname" class="form-control br-radius-zero" required="This field is required!">
                        <br><br>   
                        ...
                        <p>
                          Already an Admin? <a href="login2.php">Sign-in</a>
                        </p>  
                      </form>
                    </center>
                  </div>
